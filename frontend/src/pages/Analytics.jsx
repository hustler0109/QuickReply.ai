...
>
  <motion.div variants={fadeUp} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
    <h3 className="font-semibold mb-2">Reading Funnel</h3>
    {/* chart */}
  </motion.div>

  <motion.div variants={fadeUp} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
    <h3 className="font-semibold mb-2">Papers Over Time</h3>
    {/* line chart */}
  </motion.div>

  <motion.div variants={fadeUp} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
    <h3 className="font-semibold mb-2">Domain × Stage</h3>
    {/* stacked bar */}
  </motion.div>
</motion.div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded shadow">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={data.papersOverTime}>
            <CartesianGrid strokeDasharray="3 3" />
            <XAxis dataKey="date" />
            <YAxis />
            <Tooltip />
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded shadow">
        ...
        <p>Total Papers: {data.summary.total}</p>
        <p>Completion Rate: {data.summary.completionRate}%</p>
      </div>
    </div>
  );
}
