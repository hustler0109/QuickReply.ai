...
// <button
//   onClick={() => exportTablePDF("Research Library", columns, filtered)}
//   className="bg-black text-white px-4 py-2 rounded"
// >
//   Export PDF
// </button>
...
//     if (filters.domain)
//       params.set("domain", toPrismaEnum(filters.domain, domainMap));
//     if (filters.stage)
//       params.set("stage", toPrismaEnum(filters.stage, stageMap));
//     if (filters.impact)
//       params.set("impact", toPrismaEnum(filters.impact, impactMap));
    ...
    const fetchPapers = async () => {
      ...
      try {
        ...
        if (filters.domain) {
          query = query.eq(
            "researchDomain",
            toPrismaEnum(filters.domain, domainMap)
          );
        }
        ...
        if (filters.stage) {
          query = query.eq(
            "readingStage",
            toPrismaEnum(filters.stage, stageMap)
          );
        }
        ...
        if (filters.impact) {
          query = query.eq(
            "impactScore",
            toPrismaEnum(filters.impact, impactMap)
          );
        }
        ...
        console.error("Failed to load papers from Supabase", err);
